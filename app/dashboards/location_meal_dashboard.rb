...
class LocationMealDashboard < Administrate::BaseDashboard
  ...
  COLLECTION_ATTRIBUTES = [:id, :name, :description, :image].freeze

  # SHOW_PAGE_ATTRIBUTES
  # an array of attributes that will be displayed on the model's show page.
  SHOW_PAGE_ATTRIBUTES = [:id, :name, :description, :image, :price_cents, :location, :meal, :food_items,
                          :serving_times, :created_at, :updated_at,].freeze

  # FORM_ATTRIBUTES
  # an array of attributes that will be displayed
  # on the model's form (`new` and `edit`) pages.
  FORM_ATTRIBUTES = [:name, :description, :image, :price_cents, :location, :meal, :food_items, :serving_times].freeze
